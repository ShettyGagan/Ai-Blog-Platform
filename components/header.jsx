...
export default function Header() {
  ...
  return (
    <header className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-3xl px-4">
      ...
      <div className="backdrop-blur-xl bg-gradient-to-r from-slate-900/60 via-blue-900/40 to-slate-900/60 border border-cyan-500/30 rounded-full px-4 sm:px-6 md:px-8 py-3 flex items-center justify-between gap-2 shadow-xl shadow-cyan-500/10 hover:shadow-cyan-500/20 transition-all duration-300">
        {/* Logo */}
