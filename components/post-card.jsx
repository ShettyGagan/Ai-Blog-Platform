...
const PostCard = ({
  ...
  return (
    <Card
      className={`card-glass hover:border-cyan-500/60 hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-300 backdrop-blur-xl border-cyan-500/20 group hover:scale-[1.02] ${className}`}
    >
      <CardContent>
        <div className="space-y-4">
          ...
          <Link
            ...
            target="_blank"
          >
            <div className="relative w-full h-48 rounded-xl overflow-hidden shadow-lg group-hover:shadow-cyan-500/20 transition-shadow">
              <Image
