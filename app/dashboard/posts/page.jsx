...
export default function PostsPage() {
  ...
  return (
    <div className="space-y-6 p-4 lg:p-8 bg-gradient-to-br from-slate-950 via-blue-950/20 to-slate-950 min-h-screen">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 backdrop-blur-sm bg-slate-900/30 p-6 rounded-2xl border border-cyan-500/20">
        <div>
          <h1 className="text-4xl font-bold gradient-text-primary drop-shadow-lg">My Posts</h1>
      ...
      {/* Filters and Search */}
      <Card className="card-glass backdrop-blur-xl border-cyan-500/20">
