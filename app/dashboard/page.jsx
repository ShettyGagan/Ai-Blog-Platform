...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 p-4 lg:p-8 bg-gradient-to-br from-slate-950 via-blue-950/20 to-slate-950 min-h-screen">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 backdrop-blur-sm bg-slate-900/30 p-6 rounded-2xl border border-cyan-500/20">
        <div>
          <h1 className="text-4xl font-bold gradient-text-primary drop-shadow-lg">
            Dashboard
          </h1>
        ...
        <Link href="/dashboard/create">
          <Button variant={"primary"} className="shadow-lg shadow-cyan-500/20 hover:shadow-xl hover:shadow-cyan-500/30 hover:scale-105 transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="card-glass hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-300 border-cyan-500/20 backdrop-blur-xl group hover:scale-105">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-medium text-slate-200 group-hover:text-cyan-300 transition-colors">
              Total Views
            </CardTitle>
            <div className="p-2 bg-cyan-500/10 rounded-lg group-hover:bg-cyan-500/20 transition-all">
              <Eye className="h-5 w-5 text-cyan-400 group-hover:scale-110 transition-transform" />
            </div>
          </CardHeader>
          <CardContent>
            ...
            {stats.viewsGrowth > 0 && (
              <div className="flex items-center text-xs text-green-400 mt-2 font-medium">
        ...
        <Card className="card-glass hover:shadow-xl hover:shadow-pink-500/10 transition-all duration-300 border-pink-500/20 backdrop-blur-xl group hover:scale-105">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-medium text-slate-200 group-hover:text-pink-300 transition-colors">
              Total Likes
            </CardTitle>
            <div className="p-2 bg-pink-500/10 rounded-lg group-hover:bg-pink-500/20 transition-all">
              <Heart className="h-5 w-5 text-pink-400 group-hover:scale-110 transition-transform" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-white">
        ...
        <Card className="card-glass hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 border-purple-500/20 backdrop-blur-xl group hover:scale-105">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-medium text-slate-200 group-hover:text-purple-300 transition-colors">
              Comments
            </CardTitle>
            <div className="p-2 bg-purple-500/10 rounded-lg group-hover:bg-purple-500/20 transition-all">
              <MessageCircle className="h-5 w-5 text-purple-400 group-hover:scale-110 transition-transform" />
            </div>
          </CardHeader>
          <CardContent>
