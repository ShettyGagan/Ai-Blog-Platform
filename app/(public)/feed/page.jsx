...
export default function FeedPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950/20 to-slate-950 text-white pt-32 pb-5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Feed Header */}
        <div className="text-center mb-10 backdrop-blur-sm bg-slate-900/30 p-8 rounded-2xl border border-cyan-500/20">
          <h1 className="text-6xl font-bold gradient-text-primary pb-2 drop-shadow-lg">
