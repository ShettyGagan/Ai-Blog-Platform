  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950/20 to-slate-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        {/* Profile Header */}
        <div className="text-center mb-12 backdrop-blur-sm bg-slate-900/30 p-10 rounded-2xl border border-cyan-500/20">
          <div className="relative w-28 h-28 mx-auto mb-6">
            {user.imageUrl ? (
              <Image
                ...
                alt={user.name}
                fill
                className="rounded-full object-cover border-4 border-cyan-500/30 shadow-xl shadow-cyan-500/20"
                sizes="112px"
              />
            ) : (
